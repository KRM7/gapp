/* Simple example showing the usage of the NSGA-III. */
...
int main()
{
    ...
    */
    ...
    /* Print the results. */
    cout << "The number of pareto-optimal solutions found for the DTLZ1 problem with the NSGA-III: " << sols.size() << "\n";
    ...
    writeResultsToFile(sols, "mo_results/nsga3_dtlz1_sols.txt");              /* Every pareto-optimal solution. */
